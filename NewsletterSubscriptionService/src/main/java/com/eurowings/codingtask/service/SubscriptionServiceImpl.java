...
import com.eurowings.codingtask.dto.SubscriptionDetailsVO;
...
import com.eurowings.codingtask.repository.SubscriptionRepository;
...
public class SubscriptionServiceImpl implements SubscriptionService {
	...
	public ResponseDto getSubscriptionPermission(Long userId) {
		...
		ResponseDto userDetailsResponse = restTemplate
				.getForObject("http://USER-SERVICE/eurowings-user/api/v1/users/" + userId, ResponseDto.class);
